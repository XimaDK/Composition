...
import kadyshev.dmitry.composition.databinding.FragmentGameBinding
import kadyshev.dmitry.composition.domain.entity.GameResult
import kadyshev.dmitry.composition.domain.entity.Level
import kadyshev.dmitry.composition.presentation.fragments.GameFinishedFragment.Companion.KEY_GAME_RESULT
...
//        parseArgs()
    ...
    /*private fun parseArgs() {
        (requireArguments().getParcelable<Level>(KEY_LEVEL) as Level).let {
            level = it
        }
    }*/
        ...
        fun newInstance(level: Level): GameFragment {
            return GameFragment().apply {
                arguments = Bundle().apply {
                    ...
                    //enum классы сразу реализиуют serializable
